...
def build_model_provider(training_data: List[Result]) -> ModelProvider:
    return ModelProvider([
        ...
        Model("Enhanced Logistic Regression", train_enhanced_logistic_regression_predictor(training_data)),
        Model("Enhanced Gradient Boosting", train_enhanced_gradient_boosting_predictor(training_data)),
        Model("Form-Based", train_form_based_predictor(training_data)),
