...
class TestModelsApi(TestCase):
    ...
    def test_list_models(self) -> None:
        ...
        self.assertEqual(response.get_json(), {'models': [
            ...
            {"name": "Enhanced Logistic Regression", "predicts_in_progress": False},
            {"name": "Enhanced Gradient Boosting", "predicts_in_progress": False},
            {"name": "Form-Based", "predicts_in_progress": False},
